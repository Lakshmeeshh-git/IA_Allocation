...
?>
        <body>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <?php
                        $sem_query=mysqli_query($db_connection,"select sem from student where sem in (3,4) group by sem;");
            ...
            <div class="row">	
                <div class="col-sm-12">
                    ...
                    <?php
                        $select_each_room_3rdsem_students_query=mysqli_query($db_connection,"select usn,s_name from student where sem in (3,4) and room_no in ('$each_room_name[$c]') order by usn;");
                        $i=1;
